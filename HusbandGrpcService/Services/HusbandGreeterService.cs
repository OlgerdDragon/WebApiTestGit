    ...
    public class HusbandGreeterService : HusbandGreeter.HusbandGreeterBase, IHusbandGreeterService
    {
        ...
        public override async Task<GetShopsForVisitReply> GetShopsForVisit(UserLoginRequest request, ServerCallContext context)
        {
            try
            {
                ...
                var wantedProdutListRequest = new AdminGrpcService.GetShopsForVisitRequest { WantedProductList = new AdminGrpcService.ListOfWantedProductDto() };
                wantedProdutListRequest.WantedProductList.WantedProductDtoMessage.AddRange(wantedProductList);
                var getProductsInShopReplyHusband = await _adminServiceClient.GetShopsForVisitAsync(new AdminGrpcService.GetShopsForVisitRequest()
                {
        ...
        public override async Task<GetProductsInShopReply> GetProductsInShop(GetProductsInShopRequest request, ServerCallContext context)
        {
            try
            {
                ...
                var wantedProductList = GetWantedProducts().Element;
                var wantedProdutListRequest = new AdminGrpcService.GetProductsInShopRequest { WantedProductList = new AdminGrpcService.ListOfWantedProductDto() };
                wantedProdutListRequest.WantedProductList.WantedProductDtoMessage.AddRange(wantedProductList);
                var getProductsInShopReplyHusband = await _adminServiceClient.GetProductsInShopAsync(new AdminGrpcService.GetProductsInShopRequest()
                {
        ...
        Result<List<AdminGrpcService.WantedProductDtoMessage>> GetWantedProducts()
        {
            try
            {
                var wantedProductList = _context.WantedProducts.Select(i => new AdminGrpcService.WantedProductDtoMessage
                {
                    Id = i.Id,
                    BoughtStatus = i.BoughtStatus,
                    ProductId = i.ProductId
                ...
                return new Result<List<AdminGrpcService.WantedProductDtoMessage>>(wantedProductList);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "GetWantedProducts");
                return new Result<List<AdminGrpcService.WantedProductDtoMessage>>(ex);
            }
        }
        ...
        public override async Task<GetTotalAmountWantedProductsReply> GetTotalAmountWantedProducts(UserLoginRequest request, ServerCallContext context)
        {
            try
            {
                ...
                {
                    var product = await _adminServiceClient.GetProductAsync(new AdminGrpcService.ItemRequest {Id = item.ProductId, UserLogin = request.UserLogin } );
        ...
        public override async Task<WantedProductReply> AddWantedProduct(ItemRequest request, ServerCallContext context)
        {
            ...
            {
                var id = request.Id;
                var productItem = await _adminServiceClient.GetProductAsync(new AdminGrpcService.ItemRequest { Id = id, UserLogin = request.UserLogin });

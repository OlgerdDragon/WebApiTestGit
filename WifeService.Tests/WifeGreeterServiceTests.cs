...
namespace WifeService.Tests
{
    ...
    public class WifeGreeterServiceTests
    {
        ...
        //private AsyncUnaryCall<HusbandService.GetWantedProductsReply> GetWantedProductsReplyHusbandAsync()
        //{
        //    var result = new HusbandService.GetWantedProductsReply { Element = new HusbandService.ListOfWantedProductDto() };
        //    var data = new List<HusbandService.WantedProductDtoMessage>
        //        {
        ...
        //{
        //    //Arrange
        //    _husbandServiceClent.Setup(p => p.GetWantedProducts(It.IsAny<HusbandService.UserLoginRequest>(), It.IsAny<CallOptions>()))
        //        .Returns(GetWantedProductsReplyHusband());

        //    var test = new AsyncUnaryCall<HusbandService.GetWantedProductsReply>();

        //    _husbandServiceClent.Setup(p => p.GetWantedProductsAsync(It.IsAny<HusbandService.UserLoginRequest>(), It.IsAny<CallOptions>()))
        //       .Returns();
